                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $d->role }}</td>
                                    <td>
                                        <form id="delete-form-{{ $d->id }}" action="{{ route('register.delete', $d->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('register.action') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" id="Email" type="text" name="email" value="{{ old('email') }}" placeholder="Email"/>
                        </div>
                        ...
                        <label for="passwordconfirm">Password Konfirmasi: <span class="text-danger">*</span></label>
                        <div class="form-group">
                            <input id="passwordconfirm" type="password" name="password_confirm" placeholder="Confirm Password"
                                class="form-control">
                        </div>
